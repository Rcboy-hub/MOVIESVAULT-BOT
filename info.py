...
auth_channel = environ.get('AUTH_CHANNEL', '1002439585787') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '1002439585787')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002313408729')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesvaultgroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mediagaalaxy')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moviesscomgroup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/moviesscomgroup')
