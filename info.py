...
PICS = (environ.get('PICS', 'https://iili.io/2UzdkkQ.jpg https://iili.io/2grCuyu.jpg https://iili.io/2rCQZpn.jpg https://iili.io/2rCtUfR.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1409896358').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002366609989'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002474251929').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002251851952') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002267456913')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002474251929')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://harish:harish%402606@cluster0.wfs2u.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesvaultoffcial')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mediaagalaxy')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviesscomgroup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/mediaagalaxy')
...
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '350d6053097c06f2fff4b81d203e4d2cc3a5aefa')


# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', False)) # Set True Or False
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'http://short2url.in/http://short2url.in/')
SHORTLINK_API = environ.get('SHORTLINK_API', 'caac0ebeca0f88d106996b399a993c6e9bcc534a')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/hdmovies2792/11') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
MSG_ALRT = environ.get('MSG_ALRT', 'Hello bro ❤️')
